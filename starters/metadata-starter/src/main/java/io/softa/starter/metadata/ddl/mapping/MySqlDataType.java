package io.softa.starter.metadata.ddl.mapping;
 ...
 */
public abstract class MySqlDataType {
    ...
    static {
        ...
        // FILE stores the FileRecord Long id (see FilesGroupProcessor) → BIGINT;
        // MULTI_FILE stores a CSV of Long ids → stays VARCHAR.
        FIELD_TYPE_MAP.put(FieldType.FILE, "BIGINT");
