...
public class FlowAutomation {
     ...
     *
     * @param triggerEventDTO The API event parameters.
    ...
    public Object apiEvent(TriggerEventDTO triggerEventDTO) {
        ...
        FlowEventMessage eventMessage = wrapperFlowEventMessage(flowTrigger, flowConfig,
                triggerEventDTO.getSourceRowId(), triggerEventDTO.getEventParams());
     ...
     *
     * @param triggerEventDTO The trigger event parameters.
     * @return The Map of other field data changes caused by field value changes.
     */
    public Map<String, Object> onchangeEvent(TriggerEventDTO triggerEventDTO) {
