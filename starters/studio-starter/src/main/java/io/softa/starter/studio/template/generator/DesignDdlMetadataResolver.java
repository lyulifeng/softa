 ...
 * {@link DesignGenerationMetadataResolver} focused on studio data access and
...
public final class DesignDdlMetadataResolver implements DdlMetadataResolver {
    ...
    private final DesignGenerationMetadataResolver designResolver;

    public DesignDdlMetadataResolver(DesignGenerationMetadataResolver designResolver) {
