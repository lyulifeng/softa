...
public class DesignEnvSource {
    ...
    public DesignRows load(Long appId, Long envId) {
        ...
        // the identical rows at the same point in its own read path (MetadataReadPipeline.parse) —
        // see DesignSearchIndexSpecs for why a lane that skipped this would delete the other
        // lane's indexes on every deploy.
