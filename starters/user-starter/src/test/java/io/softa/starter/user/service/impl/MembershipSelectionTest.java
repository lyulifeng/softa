...
class MembershipSelectionTest {
    ...
    void selectableCompaniesComeFirst() {
        ...
        List<MembershipOption> options = loginService.listCompanies(PROFILE);
    ...
    void offBoardedMembershipsNeverAppear() {
        ...
        assertThat(loginService.listCompanies(PROFILE)).isEmpty();
    }
    ...
    void selectingOwnActiveMembership_isAllowed() {
        ...
        assertThat(loginService.selectCompany(PROFILE, 100L)).isEqualTo(100L);
    }
    ...
    void namingSomeoneElsesMembership_isRefused() {
        ...
        assertThatThrownBy(() -> loginService.selectCompany(PROFILE, 999L))
                .isInstanceOf(BusinessException.class)
    ...
    void selectingAFrozenMembership_isRefusedWithTheReason() {
        ...
        assertThatThrownBy(() -> loginService.selectCompany(PROFILE, 100L))
                .isInstanceOf(BusinessException.class)
