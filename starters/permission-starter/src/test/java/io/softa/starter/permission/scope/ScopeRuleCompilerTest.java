...
class ScopeRuleCompilerTest {
    ...
    /** No-op identity compiler for tests that exercise contributor dispatch /
     *  fail-closed: a bare mock returns null from {@code compile} (so the rule
     *  falls through) and false from {@code handles}. */
    private static IdentityScopeCompiler noIdentity() {
        return mock(IdentityScopeCompiler.class);
    }
    ...
    void compile_nullRules_returnsNever() {
        ScopeRuleCompiler compiler = new ScopeRuleCompiler(applicabilityAllowingAll(), noIdentity(), List.of());
    ...
    void compile_anyAllAmongOthers_shortCircuitsToNull() {
        ...
        ScopeRuleCompiler compiler = new ScopeRuleCompiler(applicabilityAllowingAll(), noIdentity(), List.of(self));
    ...
    void compile_multipleNonAllRules_orMerged() {
        ...
        ScopeRuleCompiler compiler = new ScopeRuleCompiler(applicabilityAllowingAll(), noIdentity(),
    ...
    void compile_contributorThrows_degradesToEmptyForThatRule() {
        ...
        ScopeRuleCompiler compiler = new ScopeRuleCompiler(applicabilityAllowingAll(), noIdentity(), List.of(throwing));
    ...
    void compile_inapplicableToModel_degradesToEmpty() {
        ...
        StubContributor self = new StubContributor(ScopeType.SELF,
                Filters.of("id", io.softa.framework.base.enums.Operator.EQUAL, 1L));
        ScopeRuleCompiler compiler = new ScopeRuleCompiler(applicability, noIdentity(), List.of(self));
