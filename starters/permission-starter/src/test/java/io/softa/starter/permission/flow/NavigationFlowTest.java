 ...
 * DefaultPermissionSnapshotProvider returns leaf + ancestors + granted permissions.
 */
class NavigationFlowTest {

    @BeforeEach
    void resetRequestScope() {
        // Prevent a request-scoped PermissionInfo stashed by earlier tests from
        // short-circuiting our get() calls with stale data.
    ...
    private static PermissionFlowFixture threeLevelTree() {
        ...
        fx.nav("hr", null, null);
        fx.nav("hr.employee-mgmt", "Employee", "hr");
        fx.nav("hr.employee-mgmt.employees", "Employee", "hr.employee-mgmt");
    ...
    void leafGrant_expandsAncestorsInNavigationSet() {
        ...
        PermissionInfo pi = fx.provider.get(10L, 42L);
    ...
    void grantsOnSiblingLeaves_expandsBothChains() {
        ...
        fx.nav("hr.department", "Department", "hr");
    ...
    void superAdmin_emptyGrantsSnapshot() {
        ...
        PermissionInfo pi = fx.provider.get(10L, 1L);
