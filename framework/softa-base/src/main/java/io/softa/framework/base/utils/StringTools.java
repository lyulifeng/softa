...
public class StringTools {
    ...
    public static String httpToHttps(String url) {
        ...
        url = url.trim();
        if (url.startsWith(StringConstant.HTTPS_PREFIX)) {
            return url;
        }
        return url.replace(StringConstant.HTTP_PREFIX, StringConstant.HTTPS_PREFIX);
    }
    ...
    public static String httpsToHttp(String url) {
        ...
        url = url.trim();
        return url.replace(StringConstant.HTTPS_PREFIX, StringConstant.HTTP_PREFIX);
    }
