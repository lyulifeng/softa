...
public enum ConvertType {
    /**
     * Not formatted, original database value, rarely used, such as fetching original ciphertext data.
     */
    ORIGINAL,
    /**
     * Standard formatting based on fieldType, handling dynamic calculation and dynamic cascading fields.
     */
    TYPE_CAST,
    /**
     * Enhanced display value, suitable for import and export scenarios,
     * Boolean, Option/MultiOption, ManyToOne/OneToOne, ManyToMany/OneToMany fields are processed into display values
     */
    DISPLAY,
    /**
     * Enhanced display value, suitable for front-end display,
     * Option/MultiOption, ManyToOne/OneToOne, ManyToMany/OneToMany fields are processed into OptionReference/ModelReference objects.
     */
    REFERENCE;
