CREATE TABLE sys_model(
    ...
    company_scoped TINYINT(1)  DEFAULT 0 COMMENT 'Enable Company Scope;Rows belong to one company' ,
    company_field VARCHAR(128)  DEFAULT NULL COMMENT 'Company Field;Field or path to the owning company' ,
...
CREATE TABLE sys_filter(
    ...
    filters VARCHAR(256) NOT NULL  DEFAULT '' COMMENT 'Filter Conditions' ,
...
-- checksum/diff, written by the scanner/apply on rename). mini-app has no design_* tables.
