CREATE TABLE sys_model(
    ...
    multi_country TINYINT(1)  DEFAULT 0 COMMENT 'Enable Multi-country;Rows are partitioned by country' ,
    multi_company TINYINT(1)  DEFAULT 0 COMMENT 'Enable Multi-company;Rows belong to one company' ,
...
CREATE TABLE design_activity(
    ...
    error_message MEDIUMTEXT    COMMENT 'Error Message' ,
    created_time DATETIME    COMMENT 'Created Time' ,
    created_id BIGINT(32)    COMMENT 'Created ID' ,
    created_by VARCHAR(64)    COMMENT 'Created By' ,
    updated_time DATETIME    COMMENT 'Updated Time' ,
...
CREATE TABLE design_sql_template(
    id BIGINT(32) NOT NULL   COMMENT 'ID' ,
    database_type VARCHAR(64) NOT NULL  DEFAULT '' COMMENT 'Database Type' ,
    create_table_template MEDIUMTEXT NOT NULL   COMMENT 'Create Table Template' ,
    alter_index_template MEDIUMTEXT NOT NULL   COMMENT 'Alter Index Template' ,
    alter_table_template MEDIUMTEXT NOT NULL   COMMENT 'Alter Table Template' ,
    drop_table_template MEDIUMTEXT NOT NULL   COMMENT 'Drop Table Template' ,
    description VARCHAR(256)    COMMENT 'Description' ,
    created_time DATETIME    COMMENT 'Created Time' ,
    created_id BIGINT(32)    COMMENT 'Created ID' ,
    created_by VARCHAR(64)    COMMENT 'Created By' ,
...
CREATE TABLE ai_robot(
    ...
    system_prompt MEDIUMTEXT    COMMENT 'system_prompt' ,
...
CREATE TABLE ai_message(
    ...
    content MEDIUMTEXT    COMMENT 'Query Content' ,
    input_tokens INT(11)   DEFAULT 0 COMMENT 'Input Tokens' ,
    output_tokens INT(11)   DEFAULT 0 COMMENT 'Output Tokens' ,
...
CREATE TABLE service_record(
    ...
    result_detail MEDIUMTEXT    COMMENT 'Result Detail' ,
    created_id BIGINT(32)    COMMENT 'Created ID' ,
    created_time DATETIME    COMMENT 'Created Time' ,
    created_by VARCHAR(64)    COMMENT 'Created By' ,
    updated_id BIGINT(32)    COMMENT 'Updated ID' ,
...
CREATE TABLE service_product(
    ...
    description MEDIUMTEXT    COMMENT 'Service Description' ,
